        ...
        {assentos.map((assento, index) => {
          return (
            <EscolhendoAssento
              ...
              assento={assento}
              callbackAssento={(valor) => {
                setGuardaAssento([...guardaAssento, valor]);
              }}
              callbackAssentoApi={(valor) => {
                setAssentoApi([...assentoApi, valor]);
              }}
            />
          );
        })}
      ...
      <form onSubmit={infoApi}>
        ...
        <div className="inputs cpf">
          ...
          <input
            ...
            placeholder="   Digite seu CPF sem separaçoes   EX:14474525978"
            required
          ></input>
        </div>
        <button type="submit" className="botaoReservar">
          Reservar assento(s)
        </button>
      </form>
      <Footer2 obj={info} />
